        ...
        for i in range(0, tiles):
            ...
            if other_planet is not False:
                ...
                if (pressed[pygame.K_RIGHT] or b1) and not b2:
                    ...
                    j1 = str(x).split('.')
                    j2 = str(y).split('.')
                    if (int(j1[0]) in [705,706] and int(j2[0]) in [250,251]):
                        day += 1
                    if (int(j1[0]) in [648,649] and int(j2[0]) in [144,145]) or b:
                        ...
                        if int(j1[0]) in [1100,1101]:
                            ...
                            rotation("Astronaut suit-pana 1.svg",planet,"stars2.png","Ellipse 1.png",other_planet,"rocket.png",last_planet)
...
def inspace(planet):
    ...
    rotation("Astronaut suit-pana 1.svg",f"{planet}.png","stars2.png","Ellipse 1.png",after(l),"rocket.png",before(l))